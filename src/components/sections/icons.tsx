...
import { FaCompass, FaLightbulb, FaHeart } from 'react-icons/fa'; // Import icons from FontAwesome
...
const icons = {
  ...
  settings: LuSettings,
  globalReach: AiOutlineGlobal,
  performance: ImSpinner8,
  customization: AiOutlineSliders,
  // Mode Toggle
  moon: BsMoonStars,
  sun: BsSun,
// About Us
    missionIcon: FaCompass,
    visionIcon: FaLightbulb,
    valuesIcon: FaHeart,
  // Navigation
  back: BsChevronLeft,
  next: BsChevronRight,
